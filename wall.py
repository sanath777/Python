...
#splitting variables according 2 day,direction,magnitude
for i in data:
    day.append(i[0])
    a=i[1].split(':')
    war.append(a)
...
#zipping the maximum magnitude per day
default=['N','S','W','E']
...
#finding Count and replacing default direction
q=m[0]
#initializing default direction magnitude
default1=q[1]
count=0
for i in default1:
    if(i>0):
